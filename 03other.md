...
- Mirabilis/ICQ（IM选Mi） 
- 都支持用户注册
- 用户服务器模式进行消息转发目的地判断：服务器

**Internet**：
- IP互联网（网络设计者）、信息资源网（使用者）
- 主要组分：通信线路、路由器、主机、**信息资源**
...
- 对称加密--RC开头、des/idea
- md5--对称不加密
- 1000base--T-非屏蔽 CX-屏蔽 LX-单模（5000m） SX-多模（550m） 没有W
...
- 标识服务：端口号
- P2P：理论基础是六度分割
- Maze：支持断点续传 心跳服务器 分布认证集中服务 Kerberos机制
- Mit：定义管理对象结构
- 误码率：二进制
- 交换式局域网：多节点并发
- 集线器：在物理层，不需要IP协议
